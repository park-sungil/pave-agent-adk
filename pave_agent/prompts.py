...
## 엔티티 추출
사용자 발화에서 다음을 추출하세요:
- **project**: 프로젝트명(Ulysses, Thetis, Ulysses, Vanguard) 또는 코드(S5E9945 등)
...
→ `query_data("single_cell", {"project": "Ulysses", "cell": "INV", "pdk_id": 882})`
→ `query_data("single_cell", {"project": "Ulysses", "cell": "INV", "pdk_id": 883})`
...
|---|---------|-------------|------|--------|--------|-----|-----|
| 1 | SF2 | Ulysses | EVT0 | Ulysses EVT0 | v0.9.0.0 | v0.9.5.0 | v1.0.0.0 |
| 2 | SF2 | Ulysses | EVT1 | Ulysses EVT1 | v1.0.0.0 | v0.9.5.0 | v0.9.0.0 |

사용자가 번호 또는 조건으로 선택하면 해당 pdk_id로 다시 query_data를 호출하세요.

### PDK 버전 목록
→ `query_data("versions", {"project": "Ulysses"})`
